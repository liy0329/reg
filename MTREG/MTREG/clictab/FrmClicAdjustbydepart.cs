...
{
    public partial class FrmDepartAccount : Form
    {
        BllFrxOper bllFrxOper = new BllFrxOper();
        public FrmDepartAccount()
        {
            InitializeComponent();
        }
        
        private void FrmDepartAccount_Load(object sender, EventArgs e)
        {
            //就诊类型
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            frxPrintView.viewDepartInWindow(timeBegin, timeEnd, "RCPDPT", cmbDepart.SelectedValue.ToString(), cmbPatientType.SelectedValue.ToString());
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            frxPrintView.printDepartAccount(timeBegin, timeEnd, "RCPDPT", cmbDepart.SelectedValue.ToString(), cmbPatientType.SelectedValue.ToString());
        }
        /// <summary>
        /// 设计
        /// </summary>
        ...
        private void btnDesign_Click(object sender, EventArgs e)
        {
            ...
            string tempName = "ClinicDepartAccounting.frx";
