...
namespace MTHIS.common
{
    class GetData
    {
        //获取下拉框（cmbx）或DataTable（dgv）
        public static DataTable getData(string type, List<string> columns, string tableName)
        {
            string sql = "";
            if (type.Equals("cmbx"))
            {
        ...
        //获取下拉框（cmbx）或DataTable（dgv）
        public static DataTable getData(string type, List<string> columns, string tableName,string wheresql)
        {
            string sql = "";
            if (type.Equals("cmbx"))
            {
        ...
        /// <summary>
        /// 添加人：杨慧慧 添加时间：2013-12-14 添加原因：有些汉字无法获取拼音码
        /// </summary>
        #region 汉字转化拼音缩写
        ...
        static public string convert(string chrstr)
        {
            // = new byte[2];
            string returnstr = "";
            int chrasc = 0;
                ...
                if (array.Length > 1)
                {
                    ...
                    else
                    {
                        for (int i = (pyvalue.Length - 1); i >= 0; i--)
                        {
                            if (pyvalue[i] <= chrasc)
                            {
                                returnstr += pystr[i].Substring(0, 1).ToUpper();
                                break;
                            }
                        }
                    }
