...
{
    public partial class FrmClinicCostManage : Form
    {
        ...
        private void loadDataGrid()
        {
            try
            {
                ...
                dgvInvoice.Columns["print"].HeaderText = "打印次数";
                dgvInvoice.Columns["print"].Width = (int)(160 * ProgramGlobal.WidthScale);
                dgvInvoice.Columns["print"].DisplayIndex = 15;
        ...
        private void getDgvInvoiceData()
        {
            ...
            chargeManage.HspCard = HspCard;//tbxHspcard.Text.Trim();
            chargeManage.mobile = tbxmobile.Text.Trim();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            HspCard = dthspcard.Rows[0]["hspcard"].ToString();
            getDgvInvoiceData();
            gettj();
        }
        /// <summary>
        ...
        private void btnRePrint_Click(object sender, EventArgs e)
        {
            ...
            if (Double.Parse(dgvInvoice.SelectedRows[0].Cells["print"].Value.ToString()) >= 1)
            {
                MessageBox.Show("已打印发票。请勿重复打印");
                return;
        ...
        private void gettj()
        {
            ChargeManage chargeManage = new ChargeManage();
            chargeManage.PatientName = tbxPatientName.Text.Trim();
            chargeManage.HspCard = HspCard;//tbxmobile.Text.Trim();
            chargeManage.Depart_id = cmbDepart.SelectedValue.ToString();
