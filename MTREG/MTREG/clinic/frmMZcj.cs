...
{
    public partial class frmMZcj : Form
    {
        JKDB jkdb = new JKDB();
        MZCH mzch = new MZCH();
        ...
        private void frmMZcj_Load(object sender, EventArgs e)
        {
            //初始化医保状态列表下拉选
            List<ListItem> items = new List<ListItem>();
            items.Add(new ListItem("0", "未报销"));
            items.Add(new ListItem("201", "已报销"));
        ...
        private void loadDataGrid()
        {
            try
            {
                ...
                dataGridView_brxx.Columns["regname"].Width = (int)(80 * ProgramGlobal.WidthScale);
                ...
                dataGridView_brxx.Columns["dctname"].HeaderText = "收费人";
                dataGridView_brxx.Columns["dctname"].Width = (int)(70 * ProgramGlobal.WidthScale);
                dataGridView_brxx.Columns["dctname"].DisplayIndex = 4;
                dataGridView_brxx.Columns["ys"].HeaderText = "医生";
                dataGridView_brxx.Columns["ys"].Width = (int)(70 * ProgramGlobal.WidthScale);
                dataGridView_brxx.Columns["ys"].DisplayIndex = 4;
                ...
                dataGridView_brxx.Columns["isregist"].Visible = false;
            ...
            {
                dataGridView_brxx.DataSource = null;
            }
            if (dataGridView_brxx.Rows.Count > 0)
            {
                ...
                if (cbx_ybzt.SelectedValue.ToString() == "201")
                {
                ...
                if (cbx_ybzt.SelectedValue.ToString() == "202")
                {
                    btn_ybjs.Enabled = false;
                    btn_cxjs.Enabled = false;
                    btn_cdfp.Enabled = false;
        ...
        private void getDgvInvoiceData()
        {
            ...
            chargeManage.StartDate = this.dateTime_cxrqks.Value.ToString("yyyy-MM-dd 00:00:00");
            chargeManage.EndDate = this.dateTime_cxrqjs.Value.ToString("yyyy-MM-dd 23:59:59");
            chargeManage.Islock = "";
        ...
        private void cbx_ybzt_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            else if (cbx_ybzt.SelectedValue.ToString() == "201")
            {
                btn_cdfp.Enabled = true;
                btn_jsd.Enabled = true;
                btn_cxjs.Enabled = true;
        ...
        private void combo_yllb_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            else if (this.combo_yllb.SelectedValue.ToString().Trim() == "15")
            {
                ...
                this.combo_spbz.DisplayMember = "Text";
                this.combo_spbz.ValueMember = "Value";
                this.combo_spbz.DataSource = items;
                this.combo_spbz.SelectedValue = "-1";
            ...
            else
            {
                ...
                if (yllb == "13")
                {
                    ...
                    if (!ypdzxx(this.combo_spbz.SelectedValue.ToString().Trim(), dataGridView_fyxx, in_jmylzh)) //读疾病药品对照信息
                    {
                        ...
                        //string sql_amount = "select sum(amt) from mtstuffitem where sfcxsq=1 and mtmzblstuff = " + _iid.ToString().Trim();
                        //DataTable dt_amount = hisdb.Select(sql_amount).Tables[0];
                        //string amt = dt_amount.Rows[0]["sum"].ToString().Trim();
                        //if (amt == "" || amt == null)
                        //{
                        //    amt = "0";
                        //}
                        //this.fpkcfy.Text = amt;
                        //cxXMBM();
                        //return;
                    }
                }
        ...
        private void tbx_jbbm_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void btn_ybjs_Click(object sender, EventArgs e)
        {
            ...
            string jbmc_ = this.Jzryjbmc.Text.Trim();
            chmzjs();
        }
        //城居  门诊结算 
        private void chmzjs()
        {
            ...
            //城乡门诊号
            cjmzh = DateTime.Now.ToString("yyMMddHHmmss") + "2";
            ...
            //修改医保状态      
            string sql_ybzt = "update clinic_invoice set ybsfsc = 201 where id = " + _iid.ToString() + ";";
        ...
        private void btn_cxjs_Click(object sender, EventArgs e)
        {
            ...
            string brxm = dataGridView_brxx.SelectedRows[0].Cells["regname"].Value.ToString().Trim();
            if (MessageBox.Show("确定要给[   " + brxm + "   ]撤销结算吗?", "提示信息", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                //string sql_yb = "update zlsyb_mzinfo set cxsj = '" + nowDateTime + "', tfr = " + ProgramGlobal.User_id + "  where mtmzblstuffiid = " + _iid.ToString().Trim()+";";
                string sql_yb = "update zlsyb_mzinfo set isactive = 0,cxsj = '" + nowDateTime + "', tfr = " + ProgramGlobal.User_id + "  where mtmzblstuffiid = " + _iid.ToString().Trim() + ";";
