...
{
    public partial class FrmIhspOuthsp : Form
    {
        ...
        private void FrmIhspCost_Load(object sender, EventArgs e)
        {
           ...
           // dtStatus.Rows.Add(dr4);
            ...
            this.dgvInhospital.Columns["healthcard"].HeaderText = "医保卡号";
            this.dgvInhospital.Columns["healthcard"].Width = (int)(100 * ProgramGlobal.WidthScale);
            this.dgvInhospital.Columns["AKC140"].HeaderText = "入院疾病";
            this.dgvInhospital.Columns["AKC140"].Width = (int)(100 * ProgramGlobal.WidthScale);
            ...
            this.dgvInhospital.Columns["AKA130"].Width = (int)(100 * ProgramGlobal.WidthScale);
            ...
            this.dgvInhospital.Columns["chargedate"].HeaderText = "结算时间";
            this.dgvInhospital.Columns["chargedate"].Width = (int)(130 * ProgramGlobal.WidthScale);
            this.dgvInhospital.Columns["sfyname"].HeaderText = "结算人";
            this.dgvInhospital.Columns["sfyname"].Width = (int)(100 * ProgramGlobal.WidthScale);
        ...
        private void btnAccount_Click(object sender, EventArgs e)
        {
            ...
            //删除charged='ROO'的费用
            string del_fy = "update ihsp_costdet set ihsp_id=0-ihsp_id where ihsp_id=" + id + " and charged='ROO'";
            BllMain.Db.Update(del_fy);
             //
            ...
            else if (keyname == CostInsurtypeKeyname.SELFCOST.ToString() || keyname == CostInsurtypeKeyname.GSBX.ToString())//自费
	        {
                FrmIhspAccount frmIhspAccount = new FrmIhspAccount();
                frmIhspAccount.getSource(id);
                frmIhspAccount.ShowDialog();
        ...
        private void btnRePrint_Click(object sender, EventArgs e)
        {
            ...
            string sql_print = " select print from ihsp_account  where ihsp_id = '" + id + "';";
        ...
        private void btnGsbx_Click(object sender, EventArgs e)
        {
            BllInsur bllInsur = new BllInsur();
            if (dgvInhospital.SelectedRows.Count == 0 && dgvInhospital.SelectedCells.Count == 0)
            {
            ...
            string patienttype_id = dgvInhospital.SelectedRows[0].Cells["bas_patienttype_id"].Value.ToString();
            string keyname = bllInsur.getInsurtype(patienttype_id);
            //string status = dgvInhospital.SelectedRows[0].Cells["status"].Value.ToString();
            //if (status != "SETT")
            //{
            //    MessageBox.Show("请结算后再工伤报销");
            //}
            if (keyname == "GSBX")
            {
                FrmgsCy frmsybcy = new FrmgsCy();
                frmsybcy.StartPosition = FormStartPosition.CenterScreen;
                frmsybcy.Mtzyjl_iid = id;
                frmsybcy.Zyh = dgvInhospital.Rows[rowIdx].Cells["ihspcode"].Value.ToString().Trim();
                frmsybcy.Ylkfkfs = "38";
                frmsybcy.ShowDialog(this);
            }
            else
            {
                MessageBox.Show("请选择工伤保险病人");
            }
