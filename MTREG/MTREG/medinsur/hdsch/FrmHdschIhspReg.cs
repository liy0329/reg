...
namespace MTREG.medinsur.hdsch
{
    public partial class FrmHdschIhspReg : Form
    {
        ...
        /// <param name="e"></param>
        private void FrmHdchIhspReg_Load(object sender, EventArgs e)
        {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            this.FrmIhspReg.InsurInfo.Maker = ProgramGlobal.Username;
            this.Close();
        }
        ...
        private void hdsyb()
        {
            ...
            //封锁状态
            int isblock = hdsch.dqryfsxx(dryjbxxhzh_out.Grbh, dqryfsxx_out,tbxPersonalNum.Text);
            if (isblock != 0)
            {
        ...
        {
            dgvIhspdiagn.DataSource = bllHdch.ihspdiagn(pincode);
