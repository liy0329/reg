...
{
    public partial class FrmChCy : Form
    {
        public FrmChCy()
        {
            InitializeComponent();
        ...
        private void FrmChCy_Load(object sender, EventArgs e)
        {
            initButton();
            inityjk();
            initFklx();
        ...
        public void initButton()
        {
            try
            {
                ...
                if (dt_nhflag.Rows[0]["nhflag"].ToString().Trim() == "1101")
                {
                    ...
                    btn_cxjm_zyjsmxb.Enabled = false;
                ...
                else if (dt_nhflag.Rows[0]["nhflag"].ToString().Trim() == "1102")
                {
        ...
        public void inityjk()
        {
            ...
            dgvjs_yjk.Font = new Font("宋体", (float)(11 * ProgramGlobal.WidthScale));
            dgvjs_yjk.RowsDefaultCellStyle.Font = new Font("宋体", (float)(11 * ProgramGlobal.WidthScale));
            this.dgvjs_yjk.Columns["payfee"].HeaderText = "交款金额";
            this.dgvjs_yjk.Columns["payfee"].Width = (int)(100 * ProgramGlobal.WidthScale);
            this.dgvjs_yjk.Columns["payfee"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvjs_yjk.Columns["paytypename"].HeaderText = "交款方式";
            this.dgvjs_yjk.Columns["paytypename"].Width = (int)(100 * ProgramGlobal.WidthScale);
            this.dgvjs_yjk.Columns["cheque"].HeaderText = "支票号";
            this.dgvjs_yjk.Columns["cheque"].Width = (int)(100 * ProgramGlobal.WidthScale);
            this.dgvjs_yjk.Columns["doctorname"].HeaderText = "收款人";
            this.dgvjs_yjk.Columns["doctorname"].Width = (int)(100 * ProgramGlobal.WidthScale);
            this.dgvjs_yjk.Columns["chargedate"].HeaderText = "收款时间";
            this.dgvjs_yjk.Columns["chargedate"].DefaultCellStyle.Format = "yyyy-MM-dd";
            this.dgvjs_yjk.Columns["chargedate"].Width = (int)(100 * ProgramGlobal.WidthScale);
            #endregion
            double paytotal = 0;
        ...
        private void initTpMge()
        {
            ...
            this.textBox2.Text = dt_cysj.Rows[0]["sex"].ToString().Trim();
            this.lbl_ylfkfs.Text = dt_cysj.Rows[0]["zyjlylfkfs"].ToString().Trim();
            string sql3 = "select bas_depart.name as ks,bas_doctor.name as ys from inhospital left join bas_doctor on inhospital.doctor_id=bas_doctor.id  left join bas_depart on inhospital.depart_id=bas_depart.id where inhospital.id = "+DataTool.addFieldBraces(ihsp_id);
        ...
        #region
        private void cyjsjbbm_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            cyjsjbbm.SelectAll();
        }
        ...
        public void initnull()
        {
            ...
            this.txt_bnzycs.Text = "";
            this.txt_zyqfxjdtgdy.Text = "";
            this.txt_tgzybxbltgdy.Text = "";
            this.txt_dbbxqxqfxtgdy.Text = "";
            this.txt_dbbxtgfdxtgdy.Text = "";
            this.txt_zyyljz.Text = "";
            this.txt_zdjbzyyljz.Text = "";
            this.txt_zcydtjypfy.Text = "";
            this.txt_bcfhjbylbxfyje.Text = "";
            this.txt_ljqfx.Text = "";
            this.lb_bzts.Text = "";
            this.Tbx_tsxx.Text = "";
        }
        ...
        private void tabControl1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlitem = "select ihsp_costdet.ihsp_id as Mtzyjl,ihsp_costdet.itemfrom AS Xmlb,bas_item.name AS xmmc,bas_item.standcode as Ybbm,ihsp_costdet.insurclass AS Yblx"
                               ...
                               + " GROUP BY ihsp_costdet.ihsp_id,ihsp_costdet.itemfrom,bas_item.standcode,ihsp_costdet.insurclass,ihsp_costdet.spec,ihsp_costdet.unit,bas_item.id";
        ...
        private void dataGridView3_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                //else
                //{
                    string projecttype = this.dataGridView3.Rows[e.RowIndex].Cells["Xmlb"].Value.ToString().Trim(); //dt_xmcx.Rows[0]["itemfrom"].ToString().Trim();
                    if (projecttype == "DRUG")
                    {
        ...
        private void btn_yjs_Click(object sender, EventArgs e)
        {
            ...
            //}
            //Zycjfysc cjfysc = new Zycjfysc();
            //lblFeeUpLoad.Text = "正在上传费用..........";
            //lblFeeUpLoad.Update();
            //RetMsg ret = cjfysc.ybscfymx(_iid, ylkfkfs,grbh, zyh, lblFeeUpLoad);
            //lblFeeUpLoad.Text = "正在先负担后余额..........";

            ////先负担后金额
            //string msg_ybxfdhjebz = "";
            //cjfysc.xfdhjejyb_pl(this.cyjsGrbh.Text.Trim(), ihsp_id, this.cyjsZyh.Text.Trim(), out msg_ybxfdhjebz);
            ...
            lblFeeUpLoad.Update();
            string sql = "select status,nhflag,sfck from inhospital where id=" + _iid.ToString().Trim();
            DataSet ds_sfck = BllMain.Db.Select(sql);
            //出院登记
            if (cydj() != 1)
            {
            ...
            this.tbx_qfx.Text = zyyjs_cc[7]; //
            this.tbx_gwyjjzf.Text = zyyjs_cc[17]; //
            this.tbx_bcdbzfje.Text = zyyjs_cc[23]; //


            this.txt_bnzycs.Text = zyyjs_cc[21]; //
            this.txt_zyqfxjdtgdy.Text = zyyjs_cc[27]; //
            this.txt_tgzybxbltgdy.Text = zyyjs_cc[28]; //
            this.txt_dbbxqxqfxtgdy.Text = zyyjs_cc[29]; //
            this.txt_dbbxtgfdxtgdy.Text = zyyjs_cc[30]; //
            this.txt_zyyljz.Text = zyyjs_cc[31]; //
            this.txt_zdjbzyyljz.Text = zyyjs_cc[32]; //
            this.txt_zcydtjypfy.Text = zyyjs_cc[33]; //
            this.txt_bcfhjbylbxfyje.Text = zyyjs_cc[11]; //
            this.txt_ljqfx.Text = zyyjs_cc[34]; //
            this.lb_bzts.Text = zyyjs_cc[37]; //

            this.tbx_bxzfhj.Text = (DataTool.Getdouble(zyyjs_cc[15]) + DataTool.Getdouble(zyyjs_cc[23]) + DataTool.Getdouble(zyyjs_cc[31]) + DataTool.Getdouble(zyyjs_cc[32]) + DataTool.Getdouble(zyyjs_cc[27]) + DataTool.Getdouble(zyyjs_cc[28]) + DataTool.Getdouble(zyyjs_cc[29]) + DataTool.Getdouble(zyyjs_cc[30])).ToString("0.00");
            MessageBox.Show("预结算成功，返回帐户支付金额，下一步请点结算按钮！");

            this.fymxcount();
            this.ybfy(zyh);
            //-判断自费是否结算，如果未结算，不允许城乡结算
            ...
            try
            {
                ...
                string[] retdata_hdybcc = dt_hdybcc.Rows[0]["ywccjm"].ToString().Split('|');
        ...
        private int cydj()
        {
            ...
            try
            {
                cyrq = Convert.ToDateTime(cyrq).ToString("yyyy-MM-dd HH:mm:ss");
            }
            catch
            {
                return 0;
            ...
            string sql = "update KC21 set AKC194='" + cyrq + "', AKC195='" + cyyy + "', AKC196='" + this.cyjsjbbm.Text.Trim() + "',zkc275='" + cyjb + "',zkc271='" + ys + "',zkc272='" + ks + "',aka130='" + this.combocyjsyllb.SelectedValue.ToString() + "' where AKC190='" + zyh + "'";
        ...
        private void btn_js_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("HIS系统费用与城居费用不符，不能结算！！！");
                return;
            }
            string zyh = this.cyjsZyh.Text;
            string grbh = this.cyjsGrbh.Text;
            ...
            {
                string sql_upaccount = "UPDATE ihsp_account SET insurefee = '" + tbx_bxzfhj.Text.Trim().ToString() + "' insuraccountfee = '" + cyjsZhzf.Text.Trim().ToString() + "'  WHERE ihsp_id = " + _iid.ToString();
            ...
            if (BllMain.Db.Update(insetyb) == -1)
            {
                ...
                MessageBox.Show("医保结算成功，更新zyinfo失败！" + message);
                return;
            }
            //修改his系统nhflag标志
            string date = BillSysBase.currDate();
            if (yllb == "28")
            {
                string sql2 = "update inhospital set nhflag=1102, nh_fph='" + djh + ",settInsurdate='" + date + "'  where id=" + _iid.ToString() + "; ";
                sql2 += " update inhospital set yllb = '28'  where zyjlzyh = '" + zyh + "';";
                BllMain.Db.Update(sql2);
                MessageBox.Show("年终结算成功！");
            }
            else
            {
                string sql2 = "update inhospital set nhflag=1102,nh_fph='" + djh + "' , yllb = '" + yllb + "' , settInsurdate = '" + date + "'  where id=" + _iid.ToString().Trim();
                BllMain.Db.Update(sql2);
        ...
        public int actMethod()
        {
            ...
            ihspaccount.Insurefee = tbx_bxzfhj.Text.Trim().ToString();
        ...
        public void dyfp(string strGrbh, string strZyh, string strZyjlid)
        {
            ...
            in_zfc1 += "床位费|" + cwf.ToString("0.00") + "|城乡|护理费|" + hlf.ToString("0.00") + "|城乡|诊查费|" + zcf.ToString("0.00") + "|城乡|";
            in_zfc1 += "卫生材料费|" + wsclf.ToString("0.00") + "|城乡|检查费|" + jcf.ToString("0.00") + "|城乡|药品费|" + ypf.ToString("0.00") + "|城乡|";
            in_zfc1 += "化验费|" + hyf.ToString("0.00") + "|城乡|药事服务费|" + ysfwf.ToString("0.00") + "|城乡|治疗费|" + zlf.ToString("0.00") + "|城乡|";
            in_zfc1 += "一般诊疗费|" + ybzlf.ToString("0.00") + "|城乡|手术费|" + ssf.ToString("0.00") + "|城乡|其他住院费用|" + qtzyfy.ToString("0.00") + "|城乡|输血费|" + sxf.ToString("0.00") + "|城乡|";
            ...
            in_zfc1 += (DataTool.Getdouble(zyjsddy_cc[41]) + DataTool.Getdouble(zyjsddy_cc[72]) + DataTool.Getdouble(zyjsddy_cc[73]) + DataTool.Getdouble(zyjsddy_cc[74]) + DataTool.Getdouble(zyjsddy_cc[75]) + DataTool.Getdouble(zyjsddy_cc[76]) + DataTool.Getdouble(zyjsddy_cc[77])).ToString("0.00") + "|";//医保统筹支付
            in_zfc1 += zyjsddy_cc[50] + "|";//个人账户支付
            in_zfc1 += DataTool.Getdouble(zyjsddy_cc[46]).ToString("0.00") + "|";//个人自付
            in_zfc1 += (DataTool.Getdouble(zyjsddy_cc[35]) + DataTool.Getdouble(zyjsddy_cc[36]) + DataTool.Getdouble(zyjsddy_cc[37]) + DataTool.Getdouble(zyjsddy_cc[39])).ToString("0.00") + "|";//个人自费
            in_zfc1 += zyjsddy_cc[51] + "|";//个人账户余额
            in_zfc1 += zyjsddy_cc[42] + "|";//统筹累计支付
            in_zfc1 += "标准床费:" + zyjsddy_cc[32] + "|";
            in_zfc1 += "起付线:" + zyjsddy_cc[38] + "|";
            in_zfc1 += "本次符合基本医疗费用:" + zyjsddy_cc[57] + "|";
            in_zfc1 += "住院次数:" + zyjsddy_cc[5] + "|";
            in_zfc1 += "进入大病金额:" + zyjsddy_cc[43] + "|";//
            in_zfc1 += "大病支付金额:" + zyjsddy_cc[44] + "|";
            in_zfc1 += "本年大病累计支付:" + zyjsddy_cc[45] + "|";
            in_zfc1 += "个人现金支付:" + zyjsddy_cc[52] + "|";
        ...
        {
            //String sql = "select insur_itemfrom.name as xmlb,sum(fee) as amt from insur_itemfrom,ihsp_costdet where ihsp_costdet.ihsp_id=" + mtzyjl_iid + " and  ihsp_costdet.itemtype_id=insur_itemfrom.itemtype_id and insur_itemfrom.cost_insurtype_id=6  GROUP BY xmlb ";
        ...
        {
            string mes = "确定结算回退[住院号:" + strZyh + ",姓名:" + this.cyjsXm.Text + "]吗?";
            if (MessageBox.Show(mes, "提示信息", MessageBoxButtons.OKCancel) != DialogResult.OK)
            {
                return;
            }
            ...
            string sql1 = "select ihsp_account.id from ihsp_account,inhospital where  ihsp_account.ihsp_id = inhospital.id and inhospital.id=" + ihsp_id;
            ...
            if (strYllb == "29")
            {
                ...
                //修改his医保标志
                string sql = "update inhospital set nhflag=1101,yllb = '28' ,settInsurdate =null where id=" + strZyjlId;//_iid.ToString().Trim(); //2019-3-21 增加报销时间更新为空 czh
            ...
            else
            {
                ...
                string his_sql_update_ht = "update  ihsp_costdet set insursync='N',ybxfdhje=0,ybxfdhjebz=0,dqdzxx='',yptsxx='',yblx='',insurclass='',ypspbz=0 where ihsp_id=" + strZyjlId;//
                BllMain.Db.Update(his_sql_update_ht);
                string sql = "update inhospital set nhflag=1101 ,settInsurdate =null where id=" + strZyjlId;//_iid.ToString().Trim(); //2019-3-21 增加报销时间更新为空 czh
                BllMain.Db.Update(sql);
            }
            ...
            //if (Global.IniReadValue("BXFS", "isytdnzjbx") == "1" && Global.IniReadValue("BXFS", "isxjhb") != "1")//请注意：如果【isytdnzjbx = "1"】是一台电脑直接报销结算，否则是分开报销和结算
            //{
            //    if (!gyd.Cxcydata(strZyjlId))
            //    {
            //        MessageBox.Show("撤销出院失败");
            //        return;
            //    }
            //}
            initButton();
        ...
        {
            //string sql = "select ihsp_account.id from ihsp_account,inhospital where  ihsp_account.ihsp_id = inhospital.id and inhospital.id="+ihsp_id;
            //string account_id = BllMain.Db.Select(sql).Tables[0].ToString();
        ...
        private void upcsbz_Kc22_JK0(string zyh, string djh, string yllb_)//修改kc22传输标志，置为0
        {
            string yllb = yllb_;
        ...
        private void btnXfsj_Click(object sender, EventArgs e)
        {
            ...
            if (dtxx_sfjs.Rows[0]["nhflag"].ToString() != "1101")
                return;
            ...
            Zycjfysc ybfysc = new Zycjfysc();
            RetMsg ret = ybfysc.ybscfymx(int.Parse(ihsp_id), ylkfkfs, cyjsGrbh.Text.Trim(), this.cyjsZyh.Text.Trim(), lblFeeUpLoad);
            //if (ret.Retint==false)
            //{
            //    MessageBox.Show("上传费用提示：【" + ret.Mesg + "】");
            //}
            string msg_ybxfdhjebz = "";
            ybfysc.xfdhjejyb_pl(this.cyjsGrbh.Text.Trim(), ihsp_id, this.cyjsZyh.Text.Trim(), out msg_ybxfdhjebz);
            cxfy();
            this.fymxcount();
            this.ybfy(this.cyjsZyh.Text.Trim());
            if (!string.IsNullOrEmpty(msg_ybxfdhjebz))
        ...
        private void btn_cxjm_zyjsmxb_Click(object sender, EventArgs e)
        {
            jsdcd(this.cyjsZyh.Text.Trim(), "", this.ihsp_id, this.cyjsGrbh.Text.Trim());
        }
        ...
        private void btn_cwcl_Click(object sender, EventArgs e)
        {
        ...
        private void cyjsXjsjzf_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
            {
                return;
