...
namespace MTREG.medinsur.hdyb.bll
{
    ...
    ///*
     ...
     // */
        ...
        /// <returns></returns>
        public int dryjbxx(Dryjbxx_out dryjbxx_out)
        {
            ...
            string yl = "0";
            string in_info = "";    
            int opstat = comminterface(opt_type, in_info, returnMsg, yl);
        ...
        /// <returns></returns>
        public int dryzhxx(Dryzhxx_out dryzhxx_out)
        {
        ...
        /// <returns></returns>
        public int dryjbxxzhxx(Dryjbxxhzh_out dryjbxxzhxx_out)
        {
            string opt_type = "AA311012";
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, "", returnMsg, "0");
            string ret = returnMsg.ToString();
            if (opstat != 0)
            {
        ...
        /// <returns></returns>
        public int dqryfsxx(string ryxx, Dqryfsxx_out dqryfsxx_out)
        {
            string opt_type = "AB31KC08";
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, ryxx, returnMsg, "0");
            string ret = returnMsg.ToString();
            if (opstat != 0)
            {
        ...
        /// <param name="ryxx"></param>
        /// <returns></returns>
        public int sccysj(Sccwsj_in ryxx)
        {
        ...
        /// <param name="ryxx"></param>
        /// <returns></returns>
        public int ybsjcs(Ybsjcs_in ryxx)
        {
        ...
        /// <returns></returns>
        public int dqypxx(Dqypxx_out dqypxx, string ypbm, int another)
        {
            string opt_type = "BB31KA02";
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, ypbm, returnMsg, "0");
            string ret = returnMsg.ToString();
            if (opstat != 0)
            {
                dqypxx.Message = ret;
        ...
        /// <param name="another"></param>
        /// <returns></returns>
        public int dqzlxx(string zlbm, Dqzlxx_out dqzlxx_out, int another)
        {
            string opt_type = "BB31KA03";
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, zlbm, returnMsg, "0");
            string ret = returnMsg.ToString();
            if (opstat != 0)
            {
        ...
        /// <param name="another"></param>
        /// <returns></returns>
        public int dqfwssxx(string fwssbm, Dqfwssxx_out dqfwssxx_out, int another)
        {
            string opt_type = "BB31KA04";
            //服务设施编码（His内码）
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, fwssbm, returnMsg, "0");
            string ret = returnMsg.ToString();
            if (opstat != 0)
            {
        ...
        /// <returns></returns>
        public int dqryspxx(Dryspxx_in ryxx, Dryspxx_out dryspxx_out)
        {
        ...
        /// <param name="ryxx"></param>
        /// <returns></returns>
        public int rydj_ht(Rydj_in ryxx)
        {
        ...
        /// <returns></returns>
        public int zyjs_ht(Zyjsht_in ryxx_2_in, Zyjsht_out zyjs_ht_out)
        {
        ...
        /// <returns></returns>
        public int zyjs(Zyjs_in ryxx_2_in, Zyjs_out zyjs_out)
        {
            string opt_type = "CC311003";
            //个人编号 门诊住院号，医疗类别，单据号，经办人，支付方式，帐户支付金额
        ...
        /// <returns></returns>
        public int zyjsddy(Zyjsdy_in ryxx_2_in, Zyjsddy_out zyjsddy_out)
        {
            ...
            if (endflag == "XX")
            {
                ...
                zyjsddy_out.Ddyymc = retdata[3];// retdata[3];//定点医院名称|
                ...
                zyjsddy_out.Jsrq = retdata[56];//结算日期 "2007-11-28 10:23:15" ;//
                zyjsddy_out.Ylxzxyy = retdata[57];//乙类限制性用药
                zyjsddy_out.Cxjzl = retdata[58];//超限价诊疗
                zyjsddy_out.Gwycxjzl = retdata[59];//公务员超限价诊疗
                zyjsddy_out.Gwyqfxbz = retdata[60];//公务员起付线补助
                zyjsddy_out.Gwycwfbz = retdata[61];//公务员床位费补助
                zyjsddy_out.Jrcdbjjje = retdata[62];//进入超大病基金金额
                zyjsddy_out.Cdbjjzf = retdata[63];//超大病基金支付
                zyjsddy_out.Fhgwybzjs = retdata[64];//符合公务员补助基数
                zyjsddy_out.Jrgwyjjje = retdata[65];//进入公务员基金金额
                zyjsddy_out.Bcbxze = retdata[66];//本次报销总额
                zyjsddy_out.Bczfze = retdata[67];//本次自费总额
                zyjsddy_out.Zfuje = retdata[68];//自付金额
                zyjsddy_out.Zfeije = retdata[69];//自费金额
                zyjsddy_out.Gwycxecf = retdata[70];//公务员超限额床费
            }
            else
            {
                opstat = -1;
        ...
        /// <returns></returns>
        public int dryyspgdmxbxx(string grbh, Drymxbxx_out dryyspgdmxbxx_out)
        {
        ...
        /// <returns></returns>
        public int djbypdzxx(Djbypdzxx_in djbypdzxx_in, Djbypdzxx_out djbypdzxx_out)
        {
        ...
        /// <returns></returns>
        public int mzjs_yjs(Mzjs_in ryxx_2_in, Mzjs_out mzjs_out)
        {
        ...
        /// <param name="mzjs_out"></param>
        /// <returns></returns>
        public int mzjs(Mzjs_in ryxx_2_in, Mzjs_out mzjs_out)
        {
        ...
        /// <returns></returns>
        public int mzjs_dy(Mzjsdy_in ryxx_2_in, Mzjsddy_out mzjsdy_out)
        {
        ...
        /// <summary>
        /// 20,门诊结算_回退   【入参】人员基本信息 【出参】门诊结算 金额使用的是住院结算回退结构体
        /// </summary>
        /// <param name="ryxx_in"></param>
        /// <param name="zyjs_ht_out"></param>
        /// <returns></returns>
        public int mzjs_ht(Mzjsht_in ryxx_in, Mzjsht_out zyjs_ht_out)
        {
        ...
        /// <param name="zyjs_out"></param>
        /// <returns></returns>
        public int zy_yjs(Zyjs_in ryxx_2_in, Zyjs_out zyjs_out)
        {
        ...
        /// <returns></returns>
        public int dqsyypxx(string ypbm, Dqsyypxx_out dqsyypxx_out)
        {
        ...
        /// <returns></returns>
        public int dqsyzlxx(string zlbm, Dqsyzlxx_out dqsyzlxx_out)
        {
        ...
        /// <returns></returns>
        public int dqsysbxx(Dqsysbxx_in ryxx_sy_in, Dqsysbxx_out dqsysbxx_out)
        {
        ...
        /// <returns></returns>
        public int dqdwfsxx_sy(string grbh, Dqdwfsxxsy_out dqdwfsxx_sy_out)
        {
        ...
        /// <param name="ryxx_sy_in"></param>
        /// <returns></returns>
        public int sysjcs(Ryxx_in ryxx_sy_in)
        {
        ...
        /// <param name="ryxx_sy_in"></param>
        /// <returns></returns>
        public int syrydj(Ryxx_in ryxx_sy_in)
        {
        ...
        /// <param name="ryxx_sy_in"></param>
        /// <returns></returns>
        public int syrydj_ht(Ryxx_in ryxx_sy_in)
        {
        ...
        /// <returns></returns>
        public int sycyjs(Sycyjs_in ryxx_sy_in, Sycyjs_out sycyjs_out)
        {
        ...
        /// <param name="sycyjs_out"></param>
        /// <returns></returns>
        public int sycyyjs(Sycyjs_in ryxx_sy_in, Sycyjs_out sycyjs_out)
        {
        ...
        /// <param name="ryxx_sy_in"></param>
        /// <returns></returns>
        public int sytf(Sytf_in ryxx_sy_in)
        {
        ...
        /// <returns></returns>
        public int dysyjsd(Dysyjsd_in ryxx_sy_in, Dysyjsd_out dysyjsd_out)
        {
        ...
        /// <param name="ryxx_sy_in"></param>
        /// <returns></returns>
        public int sccwsj_sy(Sccwsj_in ryxx_sy_in)
        {
            string opt_type = "BB310000";
            //单据号|门诊住院号
        ...
        /// <returns></returns>
        public int dryyspgdtsbxx(string grbh, Drymxbxx_out dryyspgdtsbxx_out)
        {
        ...
        /// 读取先负担后金额
        /// </summary>
        /// <param name="xfdhje_in"></param>
        /// <param name="xfdhje_out"></param>
        /// <returns></returns>
        public int dqkcxfdhje(Dqkcxfdhje_in xfdhje_in, Dqkcxfdhje_out xfdhje_out)
        {
            string opt_type = "BB310004";
            //住院号|处方号|his内码
            string opt_parameter = xfdhje_in.Zyh + "|" + xfdhje_in.Cfh + "|" + xfdhje_in.Hisbm;
            StringBuilder returnMsg = new StringBuilder();
            returnMsg.Capacity = 1000;
            int opstat = comminterface(opt_type, opt_parameter, returnMsg, "0");
            string ret = returnMsg.ToString();
        ...
        if (endflag == "XX")
            {
                xfdhje_out.Kcxfdhje = retdata[0]; //扣除先负担后金额|
                xfdhje_out.Ypdj = retdata[1];//药品等级
                xfdhje_out.Fylb = retdata[2];//费用类别
                xfdhje_out.Zfbl = retdata[3];//自付比例
            }
            else
            {
                opstat = -1;
                xfdhje_out.Message = ret + "[读取先负担后金额(dqkcxfdhje)]协议校验错误!";
            }
            return opstat;
        }
    }
