...
{
    public partial class FrmItemfrom : Form
    {
        ...
        private void FrmItemfrom_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = bllInsurCross.itemfromSelect(Insurtype_id);
        ...
        //    this.dgvItemfrom["insurcode", this.dgvItemfrom.RowCount - 1].Value = Insurtype_id;
        //    this.dgvItemfrom["id", this.dgvItemfrom.RowCount - 1].ReadOnly = true;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int flag = bllInsurCross.itemfromIn((DataTable)this.dgvItemfrom.DataSource, Insurtype_id);
        ...
        //    {
        //        int flag = bllInsurCross.itemfromDel(this.dgvItemfrom.SelectedCells[0].OwningRow.Cells["id"].Value.ToString());
        //        if (flag < 0)
        //        {
        ...
        {
            int flag = bllInsurCross.inItemfrom(Insurtype_id);
            if (flag < 0)
            {
