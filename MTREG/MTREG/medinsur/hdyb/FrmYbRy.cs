...
{
    public partial class FrmYbRy : Form
    {
        public FrmYbRy()
        {
            InitializeComponent();
        ...
        private void FrmYbRy_Load(object sender, EventArgs e)
        {
            initYllb();
            initMessage();
        }
        ...
        private void btn_yk_Click(object sender, EventArgs e)
        {
            ...
            string sql_gxsfck = "update inhospital set sfck=1 where id='" + this.zyjlh + "'";
            BllMain.Db.Update(sql_gxsfck);
        ...
        private bool dataUpload()
        {
            ...
            yw_in_rydj.Ybcjbz = "0";
            string sql_gxsfck = "select sfck from inhospital where id='" + this.zyjlh + "'";
            ...
            string sql2 = "update inhospital set nhflag=301 ,qfybch = 1,qh='" + txt_qybh.Text.Trim() + "',insurcode=  '" + grbh + "',yllb = '" + yllb + "',bas_patienttype_id= " + ylfkfs_id + ",Insuritemtype='40' where id= " + zyjlh + ";";//修改his系统nhflag标志，置为301
