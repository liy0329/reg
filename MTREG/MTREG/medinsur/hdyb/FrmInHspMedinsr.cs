...
{
    public partial class FrmInHspMedinsr : Form
    {
        ...
        /// <param name="e"></param>
        private void FrmInHspMedinsr_Load(object sender, EventArgs e)
        {
        ...
        {        
            ...
            string insurinfo = tbxPersonalNum.Text + "|" + tbxICCardID.Text + "|" + tbxIhspdiagn.Text + "|" + tbxIhspicd.Text + "|" + cmbYllb.SelectedValue.ToString() + "|" + tbxBalance.Text + "|" + tbxCompanyNum.Text + "|" + tbxIsBlock.Text + "|" + billCmbList.getDoctorName(ProgramGlobal.User_id);
        ...
        private void hdsyb()
        {
            ...
            //封锁状态
            int isblock = ybjk.dqryfsxx(dryjbxxhzh_out.Grbh, dqryfsxx_out);
            if (isblock != 0)
            {
        ...
        {
            dgvIhspdiagn.DataSource = bllInsur.ihspdiagn(pincode);
