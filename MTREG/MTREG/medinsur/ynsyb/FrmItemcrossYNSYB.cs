...
{
    public partial class FrmItemcrossYNSYB : Form
    {
        public FrmItemcrossYNSYB()
        {
            InitializeComponent();
        }
        BllItemcrossYNSYB bllItemcross = new BllItemcrossYNSYB();
        /// <summary>
        /// 加载
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmItemcrossYNSYB_Load(object sender, EventArgs e)
        {
        ...
        {
            CostInsurcrossYNSYB costInsurcross = new CostInsurcrossYNSYB();
        ...
        private void getDgvItem()
        {
            ...
            DataTable iteminfo = bllItemcross.getItemInfo(tbxName.Text.Trim(), itemfrom, isCross);
            dgvItemInfo.DataSource = iteminfo;
        ...
        private void tbxName2_TextChanged(object sender, EventArgs e)
        {
            ...
            dgvCostItem.DataSource = bllItemcross.getInsurInfo(tbxName2.Text.Trim(),"COST");
            btnCancelCross.Enabled = false;
            btnCross.Enabled = false;
            #region updateHeaderText
        ...
        private void tbxName3_TextChanged(object sender, EventArgs e)
        {
            ...
            dgvStuffItem.DataSource = bllItemcross.getInsurInfo(tbxName3.Text.Trim(),"STUFF");
            btnCancelCross.Enabled = false;
            btnCross.Enabled = false;
            #region updateHeaderText
