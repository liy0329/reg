    ...
    class BllItemcrossYNSYB
    {
        ...
        public DataTable getInsurInfo(string name,string itemfrom)
        {
            ...
            string sql = "select "
                       ...
                       + DataTool.addFieldBraces(CostInsurtypeKeyname.YNSYB.ToString()) + ")";
            dt = BllMain.Db.Select(sql).Tables[0];
            return dt;
        }
        ...
        public int itemCross(CostInsurcrossYNSYB costInsurcross)
        {
        ...
        {
            string sql = "select id from cost_insurtype where keyname = " + DataTool.addFieldBraces(CostInsurtypeKeyname.YNSYB.ToString());
