...
{
    public partial class FrmIhspMedinsrYNSYB : Form
    {
        public FrmIhspMedinsrYNSYB()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void FrmIhspMedinsrYNSYB_Load(object sender, EventArgs e)
        {
            ...
            itemsApproType.Add(new ListItem("03","转院审批(统筹内)"));
            itemsApproType.Add(new ListItem("04","转院审批(统筹外)"));
