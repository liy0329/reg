...
{
    public partial class FrmItemcrossGZS : Form
    {
        public FrmItemcrossGZS()
        {
            InitializeComponent();
        }
        ...
        BllItemcrossGZS bllItemcross = new BllItemcrossGZS();
        /// <summary>
        /// 初始化加载界面
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmItemcrossGZS_Load(object sender, EventArgs e)
        {
        ...
        {
            CostInsurcrossGZS costInsurcross = new CostInsurcrossGZS();
        ...
        private void tbxName1_TextChanged(object sender, EventArgs e)
        {
            ...
            dgvDrugItem.DataSource = bllItemcross.getInsurInfo(tbxName1.Text.Trim());
            #region updateHeaderText
            ...
            dgvDrugItem.Columns["insurcode"].HeaderText = "医保编码";
        ...
        private void tbxName2_TextChanged(object sender, EventArgs e)
        {
            ...
            dgvCostItem.DataSource = bllItemcross.getInsurInfo(tbxName1.Text.Trim());
            #region updateHeaderText
            ...
            dgvCostItem.Columns["insurcode"].HeaderText = "医保编码";
        ...
        private void tbxName3_TextChanged(object sender, EventArgs e)
        {
            ...
            dgvStuffItem.DataSource = bllItemcross.getInsurInfo(tbxName1.Text.Trim());
            #region updateHeaderText
            ...
            dgvStuffItem.Columns["insurcode"].HeaderText = "医保编码";
        ...
        {
            FrmDownloadItem frmDownloadItem = new FrmDownloadItem();
            frmDownloadItem.Insurtype_id = this.insurtype_id;
            frmDownloadItem.ShowDialog();
        }
    }
}
