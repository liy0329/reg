...
namespace MTREG.medinsur.hdsbhnh.bo
{
    ...
    {
        /// <summary>
        /// 在院情况查询C020003输入参数body
        /// </summary>
        /// <param name="parm"></param>
        /// <returns></returns>
        public string queryInHospitalCaseInput_body(string[] parm)
        {
            ...
            bodydata += "<D504_78>" + parm[3] + "</D504_78>";//起始登记日期
            bodydata += "<D504_79>" + parm[4] + "</D504_79>";//终止登记日期
            bodydata += "<D504_80>" + parm[5] + "</D504_80>";//HIS疾病代码
            bodydata += "<D504_81>" + parm[6] + "</D504_81>";//HIS疾病名称
            bodydata += "</body>";
            return bodydata;
        }
