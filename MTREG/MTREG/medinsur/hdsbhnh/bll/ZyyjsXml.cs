...
namespace MTREG.medinsur.hdsbhnh.bo
{
    ...
    {
        /// <summary>
        /// 住院预结算B020011输入参数body
        /// </summary>
        /// <param name="parm"></param>
        /// <returns></returns>
        public string inHospitalYjsInput_body(string[] parm)
        {
            ...
            bodydata += "<D504_100>0</D504_100>";//第三方保险
            bodydata += "</body>";
            return bodydata;
        }
