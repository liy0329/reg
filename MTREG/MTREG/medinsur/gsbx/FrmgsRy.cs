    ...
    public partial class FrmgsRy : Form
    {
        ...
        private void btn_yk_Click(object sender, EventArgs e)
        {
            ...
            data += " <sessionid>" + sessionid + "</sessionid>";
                   ...
                   data += " <aac003>" + RydjXm.Text.Trim()+ "</aac003>";
                   data+= " </injuryReqData>";
            ...
            if (dataGridView1.Rows.Count > 0)
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    try
                    {
                        ...
                        DataTable dt_gslb = hisdb.Select(sql_gslb).Tables[0];
                    ...
                    try
                    {
                        ...
                        DataTable dt_scdj = hisdb.Select(sql_scdj).Tables[0];
        ...
        {
            HISDB hisdb=new HISDB();
            string sql = "select spbh from mtzyjl where iid="+zyjlh;
            DataTable dt = hisdb.Select(sql).Tables[0];
            if (tbx_rdsh.Text.Trim() == "")
            {
                return;
            ...
            string sql_up = "update mtzyjl set spbh='' where iid="+zyjlh;
        ...
        private bool dataUpload()
        {
            ...
            string sql2 = "update mtzyjl set nhflag=501 ,rdsh='" + tbx_rdsh .Text.Trim()+ "',sfxgs='" + sfxgs + "',qh='" + txt_qybh.Text.Trim() + "',ybgrbh=  '" + RydjGrbh.Text.Trim() + "',ylfkfsname = '工伤保险',zyjlylfkfs= " + ylfkfs_id + " where iid= " + zyjlh + ";";//修改his系统nhflag标志，置为501
            string sql_in = "INSERT INTO gsryinfo(iid, grbh, name, dwmc, scdj, shbw, yllb)VALUES (" + zyjlh + ",'" + RydjGrbh.Text.Trim() + "','" + tbx_dkxm.Text.Trim() + "','" + RydjDwbh.Text.Trim() + "','" + tbx_scdj.Text.Trim() + "','" + tbx_shbw.Text.Trim() + "','" + comboYllb .Text.Trim()+ "');";
            if (hisdb.Update(sql2) == -1 || hisdb.Update(sql_in) == -1)
            {
