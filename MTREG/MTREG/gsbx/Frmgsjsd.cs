...
namespace zhongluyiyuan.gsbx
{
    public partial class Frmgsjsd : Form
    {
        ...
        {
            zhongluyiyuan.gsbx.CrystalReport1 ReportCydyfp = new zhongluyiyuan.gsbx.CrystalReport1();
        ...
        private List<Reportgsjsd> GetData(DataTable dt1, DataTable dt2,string grbh)
        {
            ...
            try
            {
                for (int i = 0; i < dt2.Rows.Count; i++)
                {
                    ...
                    rcfpdy.Shbzh = grbh;
                    rcfpdy.Gssj = dt1.Rows[0]["alc020"].ToString().Trim();
                    ...
                    DataTable dt_ryzd =BllMain.Db.Select(sql_ryzd).Tables[0];
                    ...
                    DataTable dt_cyzd = BllMain.Db.Select(sql_cyzd).Tables[0];
                    ...
                    rcfpdy.Jbr = ProgramGlobal.HspName;
